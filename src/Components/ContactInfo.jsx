...
const ContactInfo = () => {
  ...
  const handleSubmit = () => {
    if (
      ...
      const updateObject = { ...singleJobseekar, contactinfo: formData };
      ...
      >
        ...
        <div className=" flex justify-center mt-[45px]">
          <div className="flex flex-wrap gap-x-[163px] gap-y-[28px] py-[20px] px-[163px]">
            ...
            <div className="flex flex-col gap-[8px]">
              <label className="text-[#252525] text-[16px] font-normal tracking-[2%]">
                Mobile<span className="text-[#FF3F56] font-bold">*</span>
              </label>
              <input
                name="mobile"
            ...
            <div className="flex flex-col gap-[8px]">
              <label className="text-[#252525] text-[16px] font-normal tracking-[2%]">
                Country<span className="text-[#FF3F56] font-bold">*</span>
              </label>
              <input
                name="country"
            ...
            <div className="flex flex-col gap-[8px]">
              <label className="text-[#252525] text-[16px] font-normal tracking-[2%]">
                City<span className="text-[#FF3F56] font-bold">*</span>
              </label>
              <input
                name="city"
                value={formData.city}
        ...
        <div className="flex flex-wrap gap-y-[20px] gap-x-[163px] px-[163px]  text-center mt-12">
          <Link to="/basicinfo">
